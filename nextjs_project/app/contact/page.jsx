  ...
  return (
    <main className="relative w-full bg-transparent text-black dark:text-white">
      ...
      <section className="relative py-24 text-center">
        ...
        <p className="text-lg">We’re here to make your events unforgettable ✨</p>
      </section>
      ...
      <section className="py-16 px-6 max-w-4xl mx-auto grid md:grid-cols-2 gap-15">
        {[
          {
            title: "📍 Our Location",
            desc: "Near Maliwal Gas Godown, Jyoti Nagar, Jatharpeth, Akola",
          },
          {
          ...
          <div
            key={i}
            className="p-6 bg-white/10 dark:bg-white/5 backdrop-blur-lg border border-white/20 rounded-xl shadow-lg hover:shadow-yellow-400/40 transition-all"
          >
      ...
      <section className="py-16 px-6 max-w-4xl mx-auto text-center">
        ...
        <p className="mt-2 text-lg">Founder, Royal Events</p>
