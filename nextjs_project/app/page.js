...
export default function Home() {
  ...
  return (
    <main className="relative w-full bg-transparent text-gray-900 dark:text-gray-100">
      {/* ================= Hero Section ================= */}
      ...
      <div className="relative w-full bg-transparent">
        {/* ================= Services Section ================= */}
        <section className="py-20 px-6 bg-transparent  text-gray-900 dark:text-gray-100 relative z-10">
        ...
        {/* ================= About Section ================= */}
        <section className="py-20 px-6 bg-black text-gray-900 dark:text-gray-100 relative z-10">
